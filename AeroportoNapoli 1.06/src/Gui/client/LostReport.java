...
public class LostReport extends BasePanel implements Resettable{
    
    public LostReport(JPanel container,PanelController panelController) {
    ...
    private void initComponents() {
        ...
        reporttable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FLIGHT", "LUGGAGE ID", "REPORT CODE", "REPORT STATUS"
            }
        ) {
