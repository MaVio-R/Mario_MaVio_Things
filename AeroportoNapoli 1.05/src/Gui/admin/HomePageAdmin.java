...
public class HomePageAdmin extends BasePanel implements Resettable{
    ...
    public HomePageAdmin(JPanel container,PanelController panelController) {
        ...
        Timer timer = new Timer(30000, e -> Controller.loadFlightData(flighttable));
        timer.start();
    }
    ...
    private void initComponents() {
        ...
        flighttable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD VOLO", "STATO VOLO", "PARTENZA", "ARRIVO", "ORARIO", "RITARDO", "GATE"
            }
        ) {
    ...
    private void UpdateLostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateLostActionPerformed
        panelController.showPanel("lostupdate");
