...
private final JPanel container;
    ...
    private JPanel createPanel(String name) {
        switch (name) {
            ...
            case "lostreport": return new LostReport(container,this);
            case "clientprofile": return new ClientProfile(container,this);
            case "clientprofileupdate": return new ClientProfileUpdate(container,this);
            ...
            case "lostupdate": return new LostUpdate(container,this);
            default: return null;
        }
    }
}