...
public class FlightUpdate extends javax.swing.JPanel {
    ...
    public FlightUpdate(JPanel container) {
        ...
        Timer timer = new Timer(30000, e -> Controller.loadFlightDataForAdminUpdate(flighttable));
        timer.start();        
    }
    ...
    private void initComponents() {
        ...
        flighttable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight_number", "Departure", "Destination", "STATUS"
            }
        ) {
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Flight myFlight = new Flight(id, flightNum, Company, ScheduledDate, PlannedTime, DelayTime, Departure, Arrival, Gate, status);
                departure.setText(Departure);
                destination.setText(Arrival);
                flightcompany.setText(Company);
                date.setText(ScheduledDate);
                time.setText(PlannedTime);
                gate.setText(Gate);
                delay.setText(DelayTime);
                            
                flightstatus.setSelectedItem(StatusStr.toUpperCase());
            } else {
                JOptionPane.showMessageDialog(this,
    ...
    private void checkinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkinActionPerformed
        ...
        String Gate = gate.getText().trim();    // Gate è una stringa
        String Status = flightstatus.getSelectedItem().toString();
        String Delay = delay.getText().trim();
        String flightNum = flightnum.getText().trim();
        ...
        try {
            ...
            if (addedrow > 0) {
                ...
                JOptionPane.showMessageDialog(this, "No flight found with the provided flight number.", "Warning", JOptionPane.WARNING_MESSAGE);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this,
    ...
    private javax.swing.JComboBox<FlightStatus> flightstatus;
