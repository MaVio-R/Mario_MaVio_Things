...
void gameOver()
{
	...
	if(LifeCounter == 0){
		...
		printf("\n\033[1;31m    OH NOOO THE NONO SQUARE");
}

void displayMap()
{
	//Semplificato i colori 
	//Aggiunto il reset del colore dopo ogni stampa perch� i fantasmi cambiavano colori ai muri
	//qua dentro non si dovrebbe toccare pi� niente
	...
	printf("\n \033[0;36m	SCORE : %d LIFE: %i", score,LifeCounter);
	printf("\n\033[0;36m	ESC per uscire.");
...
void move()
{
	while(click != 27)
	{
		...
		// che ci sta da scrovere meglio ?  va bene cos�, a funzionare funziona quindi va bene non si puo ottimizzare credo
